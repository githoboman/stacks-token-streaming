;; title: stream
;; version: 2.0
;; summary: Token streaming contract with Clarity 4
;; description: Stream STX tokens over time with scheduled payments
...
;; Update stream configuration with signature verification
...
(define-read-only (current-block-height)
  (get height (unwrap-panic (get-block-info?))))
